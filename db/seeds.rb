...
categories = [
  ...
  {name: 'Build tools', description: 'Addons related to preprocessing, broccoli plugins and dependencies of ember-cli', position: 4},
  {name: 'Components', description: 'Addons that provide a component', position: 5},
